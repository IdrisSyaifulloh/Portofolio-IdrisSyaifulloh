...
export function Hero() {
  ...
  const fullText = 'Tukang Ngoding Jago';
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="hidden md:block absolute top-1/4 right-1/4 w-64 h-64 border border-gray-200 dark:border-gray-800 rounded-full opacity-20"
        animate={{ 
          rotate: 360,
          scale: [1, 1.1, 1],
        }}
      ...
      <motion.div
        className="hidden md:block absolute bottom-1/4 left-1/4 w-48 h-48 bg-black dark:bg-white opacity-[0.02] rounded-lg"
        animate={{ 
          rotate: -360,
        }}
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-8 lg:px-12 pt-20 sm:pt-24 lg:pt-0">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <motion.p
                ...
                className="text-base sm:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mb-10 sm:mb-12 leading-relaxed font-light"
              ...
              >
                <span className="text-[10px] sm:text-xs tracking-[0.2em] text-gray-400 dark:text-gray-500 font-medium">CONNECT</span>
                <motion.div 
            ...
            <div className="order-1 lg:order-2">
              ...
              >
                ...
                >
                  ...
                  <motion.div
                    className="hidden sm:block absolute -bottom-6 -right-6 px-6 py-4 bg-white dark:bg-black border-2 border-black dark:border-white rounded-2xl shadow-xl"
                  ...
                  {/* Stats Badge - Years */}
                  <motion.div
                    className="hidden sm:block absolute -top-6 -left-6 px-4 py-3 bg-black dark:bg-white rounded-xl shadow-xl"
      ...
      {/* Scroll Indicator */}
      <motion.div
        className="hidden sm:block absolute bottom-12 left-1/2 -translate-x-1/2 cursor-pointer group"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
...
function MagneticButton({ 
  ...
  let classes = 'group relative px-5 py-3 sm:px-8 sm:py-4 text-sm sm:text-base font-light tracking-wide overflow-hidden inline-flex items-center space-x-2 transition-all duration-300 ';
