...
export function Hero() {
  return (
    ...
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="order-2 lg:order-1 pt-12 lg:pt-0">
            ...
            <motion.div
              ...
              className="inline-block px-4 py-2 border-2 border-dashed border-[#00D084] text-black dark:text-white font-medium text-sm sm:text-base mb-6 relative"
            >
              <div className="absolute -left-1.5 -top-1.5 w-3 h-3 bg-[#00D084]" />
              <div className="absolute -right-1.5 -top-1.5 w-3 h-3 bg-[#00D084]" />
              <div className="absolute -left-1.5 -bottom-1.5 w-3 h-3 bg-[#00D084]" />
              <div className="absolute -right-1.5 -bottom-1.5 w-3 h-3 bg-[#00D084]" />
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl lg:text-7xl font-bold text-black dark:text-white leading-[1.1] mb-6 tracking-tight"
            >
            ...
            >
              ...
              >
                Get In Touch <ArrowUpRight className="w-5 h-5 text-[#00D084]" />
                <div className="absolute top-1 left-1 w-full h-full bg-[#00D084] -z-10" />
              </a>
            ...
            >
              ...
              <a href="https://www.linkedin.com/in/idris-syaifulloh-b36478263/" className="w-10 h-10 rounded-full bg-[#00D084] flex items-center justify-center text-white hover:bg-[#00b373] transition-colors border border-[#00D084]">
          ...
          <div className="order-1 lg:order-2 relative mt-8 lg:mt-0">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] -z-20 pointer-events-none hidden md:block">
            ...
            <motion.div
              ...
              className="relative mx-auto w-full max-w-[400px] xl:max-w-[480px]"
            >
              {/* Black background offset */}
              <div className="absolute top-4 left-4 xl:top-6 xl:left-6 w-full h-full bg-black dark:bg-gray-800 -z-10" />
              
              {/* Image */}
              <div className="relative aspect-[4/5] bg-gray-200 border-2 border-black dark:border-gray-800 overflow-hidden">
                <ImageWithFallback
                  src={Gua}
                ...
                <div className="relative w-full h-full flex items-center justify-center">
                  ...
                  <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100">
                    <path
                      ...
                      fill="none"
                    />
                    <text className="text-[11px] font-medium uppercase tracking-widest fill-black dark:fill-white">
      ...
      {/* Marquee Banner */}
      <div className="absolute bottom-0 left-0 w-full bg-black text-white overflow-hidden py-4 border-b-4 border-[#00D084]">
